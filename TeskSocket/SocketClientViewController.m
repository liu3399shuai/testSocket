...
{
    if (showScreenViewController == nil)
    {
        if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone)
        {
            showScreenViewController = [[SocketShowScreenViewController alloc] initWithNibName:@"SocketShowScreenViewController_iPhone" bundle:nil];
        }
        else
        {
//            showScreenViewController = [[SocketShowScreenViewController alloc] initWithNibName:@"SocketShowScreenViewController_iPad" bundle:nil];
        }
    }
    isSharing = YES;
    [self presentModalViewController:showScreenViewController animated:YES];
    
    [self writeData:@"alowscreen"];

}

- (void)hideServerScreen
{
    [showScreenViewController backWasPressed:nil];
    isSharing = NO;
}

- (void)showScreenData
{
    [self insertStringToTable:@"showScreenData"];
    showScreenViewController.screenView.image = [UIImage imageWithData:imageData];
}
